...
complete --command namseokcoin-qt --no-files

# Extract options
function __fish_namseokcoinqt_get_options
...
complete \
    --command namseokcoin-qt \
    --arguments "(__fish_namseokcoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c namseokcoin-qt \
...
complete \
    --command namseokcoin-qt \
    --arguments "(__fish_namseokcoinqt_get_options --nofiles)"
