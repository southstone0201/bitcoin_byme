...
# Extract options
function __fish_namseokcoin_tx_get_options
...
# Extract commands
function __fish_namseokcoin_tx_get_commands
...
# Add options
complete \
    --command namseokcoin-tx \
    --condition "not __fish_namseokcoin_seen_cmd (__fish_namseokcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_namseokcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command namseokcoin-tx \
    --arguments "(__fish_namseokcoin_tx_get_commands)" \
    --no-files
