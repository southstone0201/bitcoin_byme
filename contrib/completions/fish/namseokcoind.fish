...
complete --command namseokcoind --no-files

# Extract options
function __fish_namseokcoind_get_options
...
complete \
    --command namseokcoind \
    --arguments "(__fish_namseokcoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command namseokcoind \
...
complete \
    --command namseokcoind \
    --arguments "(__fish_namseokcoind_get_options --nofiles)"
