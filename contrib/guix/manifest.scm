...
(define* (make-namseokcoin-cross-toolchain target
                                       #:key
...
desirable for building Namseokcoin Core release binaries."
...
;; failure; see https://github.com/namseokcoin/namseokcoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-namseokcoin-cross-toolchain target)))
