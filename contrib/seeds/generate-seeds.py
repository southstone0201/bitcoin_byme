...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef NAMSEOKCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define NAMSEOKCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the namseokcoin network\n')
    ...
    g.write('#endif // NAMSEOKCOIN_CHAINPARAMSSEEDS_H\n')
