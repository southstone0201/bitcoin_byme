...
"""Example logging Namseokcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/namseokcoind
...
def main(namseokcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[namseokcoind_with_usdts])
