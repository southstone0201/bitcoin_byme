...
Assumeutxo is a feature that allows fast bootstrapping of a validating namseokcoind
instance.
...
```
$ namseokcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ namseokcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
