...
This guide describes how to build namseokcoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run namseokcoind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/namseokcoin/namseokcoin/blob/master/doc/descriptors.md).
...
There are many ways to configure Namseokcoin Core. Here is an example that
