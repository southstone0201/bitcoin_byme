Namseokcoin Core version 0.10.3 is now available from:

  <https://namseokcoin.org/bin/namseokcoin-core-0.10.3/>
...
(see https://github.com/namseokcoin/namseokcoin/pull/6793, as well as the 0.11.0
