Namseokcoin Core version 0.10.4 is now available from:

  <https://namseokcoin.org/bin/namseokcoin-core-0.10.4/>
...
- #6953 `43c2789` Split namseokcoin-tx into its own package
- #6953 `dfe0d4d` Include namseokcoin-tx binary on Debian/Ubuntu
