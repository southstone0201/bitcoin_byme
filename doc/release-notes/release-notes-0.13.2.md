Namseokcoin Core version 0.13.2 is now available from:

  <https://namseokcoin.org/bin/namseokcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update namseokcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow namseokcoin-tx to create v2 transactions (btcdrak)
