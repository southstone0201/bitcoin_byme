Namseokcoin Core version *0.15.0.1* is now available from:

  <https://namseokcoin.org/bin/namseokcoin-core-0.15.0.1/>

and

  <https://namseokcoincore.org/bin/namseokcoin-core-0.15.0.1/>
