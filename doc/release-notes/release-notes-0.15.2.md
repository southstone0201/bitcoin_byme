Namseokcoin Core version *0.15.2* is now available from:

  <https://namseokcoincore.org/bin/namseokcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in namseokcoin-tx (TheBlueMatt)
