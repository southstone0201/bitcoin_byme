Namseokcoin Core version 0.16.1 is now available from:

  <https://namseokcoincore.org/bin/namseokcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting namseokcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure namseokcoind processes are cleaned up when tests end (sdaftuar)
