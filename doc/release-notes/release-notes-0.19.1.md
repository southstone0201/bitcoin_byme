...
Namseokcoin Core version 0.19.1 is now available from:

  <https://namseokcoincore.org/bin/namseokcoin-core-0.19.1/>
...
From Namseokcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Namseokcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Namseokcoin Core does not yet change appearance when
...
- #17488 fix "namseokcoind already running" warnings on macOS (fanquake)
