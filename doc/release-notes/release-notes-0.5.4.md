Namseokcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/namseokcoin/files/Namseokcoin/namseokcoin-0.5.4/
...
http://gitorious.org/namseokcoin/namseokcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Namseokcoin-Qt notifications under Growl 1.3.
Increase required age of Namseokcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNamseokcoin properly when installing Namseokcoin-Qt over it. (Windows)
