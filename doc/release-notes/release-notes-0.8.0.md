Namseokcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/namseokcoin/files/Namseokcoin/namseokcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Namseokcoin
...
New/changed settings (command-line or namseokcoin.conf file)
--------------------------------------------------------
