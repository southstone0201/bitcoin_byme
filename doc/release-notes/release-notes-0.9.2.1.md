Namseokcoin Core version 0.9.2.1 is now available from:

  https://namseokcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NSC to 0.01 NSC
...
- Fix "Start namseokcoin on system login"
