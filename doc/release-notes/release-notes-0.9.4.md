Namseokcoin Core version 0.9.4 is now available from:

  https://namseokcoin.org/bin/0.9.4/
...
this update is incompatible with the Namseokcoin system and could lead to consensus
forks.

Namseokcoin Core released binaries from https://namseokcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~namseokcoin/+archive/ubuntu/namseokcoin
- A third-party or self-compiled Namseokcoin Core

upgrade to Namseokcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
