...
Namseokcoin Core version 26.2 is now available from:

  <https://namseokcoincore.org/bin/namseokcoin-core-26.2/>
...
using the Linux kernel, macOS 11.0+, and Windows 7 and newer.  Namseokcoin
