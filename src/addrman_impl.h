...
#ifndef NAMSEOKCOIN_ADDRMAN_IMPL_H
#define NAMSEOKCOIN_ADDRMAN_IMPL_H
 ...
 * see https://namseokcoincore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // NAMSEOKCOIN_ADDRMAN_IMPL_H
