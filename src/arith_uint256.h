...
#ifndef NAMSEOKCOIN_ARITH_UINT256_H
#define NAMSEOKCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Namseokcoin only uses this "compact" format for encoding difficulty
...
#endif // NAMSEOKCOIN_ARITH_UINT256_H
