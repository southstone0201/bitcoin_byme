...
#ifndef NAMSEOKCOIN_COMMON_ARGS_H
#define NAMSEOKCOIN_COMMON_ARGS_H
...
extern const char * const NAMSEOKCOIN_CONF_FILENAME;
extern const char * const NAMSEOKCOIN_SETTINGS_FILENAME;
...
#endif // NAMSEOKCOIN_COMMON_ARGS_H
