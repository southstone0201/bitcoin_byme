...
// Copyright (c) 2009-2020 The Namseokcoin Core developers
...
#ifndef NAMSEOKCOIN_COMMON_MESSAGES_H
#define NAMSEOKCOIN_COMMON_MESSAGES_H
...
#endif // NAMSEOKCOIN_COMMON_MESSAGES_H
