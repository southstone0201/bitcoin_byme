...
#ifndef NAMSEOKCOIN_COMMON_SETTINGS_H
#define NAMSEOKCOIN_COMMON_SETTINGS_H
...
//!       https://github.com/namseokcoin/namseokcoin/pull/15934/files#r337691812)
...
#endif // NAMSEOKCOIN_COMMON_SETTINGS_H
