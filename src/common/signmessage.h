...
#ifndef NAMSEOKCOIN_COMMON_SIGNMESSAGE_H
#define NAMSEOKCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's namseokcoin address, it must refer to a public key.
...
#endif // NAMSEOKCOIN_COMMON_SIGNMESSAGE_H
