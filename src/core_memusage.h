// Copyright (c) 2015-2018 The Namseokcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NAMSEOKCOIN_CORE_MEMUSAGE_H
#define NAMSEOKCOIN_CORE_MEMUSAGE_H
...
#endif // NAMSEOKCOIN_CORE_MEMUSAGE_H
