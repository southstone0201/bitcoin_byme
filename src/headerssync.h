...
#ifndef NAMSEOKCOIN_HEADERSSYNC_H
#define NAMSEOKCOIN_HEADERSSYNC_H
 ...
 *
 * The Namseokcoin protocol does not offer an easy way to determine the work on a
...
#endif // NAMSEOKCOIN_HEADERSSYNC_H
