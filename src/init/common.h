...
//! @file
//! @brief Common init functions shared by namseokcoin-node, namseokcoin-wallet, etc.

#ifndef NAMSEOKCOIN_INIT_COMMON_H
#define NAMSEOKCOIN_INIT_COMMON_H
...
#endif // NAMSEOKCOIN_INIT_COMMON_H
