...
#ifndef NAMSEOKCOIN_INTERFACES_INIT_H
#define NAMSEOKCOIN_INTERFACES_INIT_H
...
//! (namseokcoin-gui, namseokcoin-node, namseokcoin-wallet, namseokcoind, namseokcoin-qt) and each
...
#endif // NAMSEOKCOIN_INTERFACES_INIT_H
