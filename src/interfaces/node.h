...
#ifndef NAMSEOKCOIN_INTERFACES_NODE_H
#define NAMSEOKCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a namseokcoin node (namseokcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or namseokcoin.conf.
...
#endif // NAMSEOKCOIN_INTERFACES_NODE_H
