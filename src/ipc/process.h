...
#ifndef NAMSEOKCOIN_IPC_PROCESS_H
#define NAMSEOKCOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning namseokcoin processes and serving requests
...
#endif // NAMSEOKCOIN_IPC_PROCESS_H
