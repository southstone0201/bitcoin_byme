...
#ifndef NAMSEOKCOIN_LOGGING_H
#define NAMSEOKCOIN_LOGGING_H
...
namespace BCLog {
    ...
    public:
         ...
         * Mostly intended for libnamseokcoin-kernel apps that don't want any logging.
