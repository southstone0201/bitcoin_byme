...
#ifndef NAMSEOKCOIN_NODE_CONNECTION_TYPES_H
#define NAMSEOKCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/namseokcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Namseokcoin’s Peer-to-Peer Network")
...
#endif // NAMSEOKCOIN_NODE_CONNECTION_TYPES_H
