...
#ifndef NAMSEOKCOIN_POLICY_FEERATE_H
#define NAMSEOKCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "NSC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    NSC_KVB,      //!< Use NSC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::NSC_KVB) const;
...
#endif // NAMSEOKCOIN_POLICY_FEERATE_H
