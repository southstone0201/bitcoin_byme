...
#ifndef NAMSEOKCOIN_PROTOCOL_H
#define NAMSEOKCOIN_PROTOCOL_H
...
/**
 * Namseokcoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Namseokcoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // namseokcoin-development mailing list. Remember that service bits are just
