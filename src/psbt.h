...
#ifndef NAMSEOKCOIN_PSBT_H
#define NAMSEOKCOIN_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Namseokcoin transaction.) Returns true if the merge succeeded, false otherwise. */
