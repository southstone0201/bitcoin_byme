...
#ifndef NAMSEOKCOIN_QT_GUIUTIL_H
#define NAMSEOKCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Namseokcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "namseokcoin:" URI into recipient object, return true on successful parsing
...
#endif // NAMSEOKCOIN_QT_GUIUTIL_H
