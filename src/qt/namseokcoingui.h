...
#ifndef NAMSEOKCOIN_QT_NAMSEOKCOINGUI_H
#define NAMSEOKCOIN_QT_NAMSEOKCOINGUI_H
...
/**
  Namseokcoin GUI main class. This class represents the main window of the Namseokcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NamseokcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NamseokcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~NamseokcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a namseokcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, NamseokcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Namseokcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(NamseokcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // NAMSEOKCOIN_QT_NAMSEOKCOINGUI_H
