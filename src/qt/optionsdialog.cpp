      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->namseokcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->namseokcoinAtStartup);
    ...
    ui->namseokcoinAtStartup->setToolTip(ui->namseokcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->namseokcoinAtStartup->setText(ui->namseokcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openNamseokcoinConfButton->setToolTip(ui->openNamseokcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new NamseokcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->namseokcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSNSControls);
...
void OptionsDialog::on_openNamseokcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openNamseokcoinConf())
