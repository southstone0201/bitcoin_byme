...
#ifndef NAMSEOKCOIN_QT_OPTIONSDIALOG_H
#define NAMSEOKCOIN_QT_OPTIONSDIALOG_H
...
private Q_SLOTS:
    ...
    void on_openNamseokcoinConfButton_clicked();
...
#endif // NAMSEOKCOIN_QT_OPTIONSDIALOG_H
