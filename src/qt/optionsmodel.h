...
#ifndef NAMSEOKCOIN_QT_OPTIONSMODEL_H
#define NAMSEOKCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Namseokcoin client.
...
public:
    ...
    NamseokcoinUnit getDisplayUnit() const { return m_display_namseokcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSNSControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    NamseokcoinUnit m_display_namseokcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(NamseokcoinUnit unit);
...
#endif // NAMSEOKCOIN_QT_OPTIONSMODEL_H
