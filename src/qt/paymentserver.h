...
#ifndef NAMSEOKCOIN_QT_PAYMENTSERVER_H
#define NAMSEOKCOIN_QT_PAYMENTSERVER_H
...
extern const QString NAMSEOKCOIN_IPC_PREFIX;
...
#endif // NAMSEOKCOIN_QT_PAYMENTSERVER_H
