...
#ifndef NAMSEOKCOIN_QT_SENDCOINSENTRY_H
#define NAMSEOKCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending namseokcoins.
 */
...
#endif // NAMSEOKCOIN_QT_SENDCOINSENTRY_H
