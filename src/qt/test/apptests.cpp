...
//! Entry point for NamseokcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &NamseokcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for NamseokcoinGUI tests.
void AppTests::guiTests(NamseokcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NamseokcoinGUI::consoleShown, this, &AppTests::consoleTests);
