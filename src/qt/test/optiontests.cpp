...
{
    // Test regression https://github.com/namseokcoin/namseokcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/namseokcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/namseokcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Namseokcoin/Namseokcoin-Qt.conf and all else left as default,
    // namseokcoin-qt should set both -listen and -listenonion to false and start successfully.
