...
#ifndef NAMSEOKCOIN_QT_WALLETMODEL_H
#define NAMSEOKCOIN_QT_WALLETMODEL_H
...
/** Interface to Namseokcoin wallet from Qt view code. */
...
#endif // NAMSEOKCOIN_QT_WALLETMODEL_H
