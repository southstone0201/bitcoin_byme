...
#ifndef NAMSEOKCOIN_RPC_PROTOCOL_H
#define NAMSEOKCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in namseokcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Namseokcoin is not connected
...
#endif // NAMSEOKCOIN_RPC_PROTOCOL_H
