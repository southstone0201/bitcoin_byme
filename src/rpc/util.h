...
#ifndef NAMSEOKCOIN_RPC_UTIL_H
#define NAMSEOKCOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting NSC/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1NSC/kvB.
 */
