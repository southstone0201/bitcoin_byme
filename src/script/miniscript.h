...
#ifndef NAMSEOKCOIN_SCRIPT_MINISCRIPT_H
#define NAMSEOKCOIN_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a namseokcoin script
...
#endif // NAMSEOKCOIN_SCRIPT_MINISCRIPT_H
