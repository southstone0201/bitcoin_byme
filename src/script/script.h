...
#ifndef NAMSEOKCOIN_SCRIPT_SCRIPT_H
#define NAMSEOKCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Namseokcoin always counted CHECKMULTISIGs
...
#endif // NAMSEOKCOIN_SCRIPT_SCRIPT_H
