...
#ifndef NAMSEOKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define NAMSEOKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // NAMSEOKCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
