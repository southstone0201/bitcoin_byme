// Copyright (c) 2016-2018 The Namseokcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NAMSEOKCOIN_SUPPORT_EVENTS_H
#define NAMSEOKCOIN_SUPPORT_EVENTS_H
...
#endif // NAMSEOKCOIN_SUPPORT_EVENTS_H
