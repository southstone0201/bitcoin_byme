// Copyright (c) 2012-2022 The Namseokcoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.namseokcoincore.org", "www.namseokcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.namseokcoincore.org]", "www.namseokcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.namseokcoincore.org:80", "www.namseokcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.namseokcoincore.org]:80", "www.namseokcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.namseokcoincore.org:65536", "www.namseokcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.namseokcoincore.org:0", "www.namseokcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.namseokcoincore.org:", "www.namseokcoincore.org:", 0, false));
}
