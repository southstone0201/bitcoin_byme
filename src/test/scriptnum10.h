...
#ifndef NAMSEOKCOIN_TEST_SCRIPTNUM10_H
#define NAMSEOKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Namseokcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // NAMSEOKCOIN_TEST_SCRIPTNUM10_H
