// Copyright (c) 2015-present The Namseokcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NAMSEOKCOIN_TEST_UTIL_SETUP_COMMON_H
#define NAMSEOKCOIN_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/namseokcoin/namseokcoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // NAMSEOKCOIN_TEST_UTIL_SETUP_COMMON_H
