// Copyright (c) 2015-2021 The Namseokcoin Core developers
 ...
 */
#ifndef NAMSEOKCOIN_TORCONTROL_H
#define NAMSEOKCOIN_TORCONTROL_H
...
/****** Namseokcoin specific TorController implementation ********/
...
#endif // NAMSEOKCOIN_TORCONTROL_H
