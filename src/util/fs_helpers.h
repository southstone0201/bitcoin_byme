...
// Copyright (c) 2009-2023 The Namseokcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NAMSEOKCOIN_UTIL_FS_HELPERS_H
#define NAMSEOKCOIN_UTIL_FS_HELPERS_H
...
#endif // NAMSEOKCOIN_UTIL_FS_HELPERS_H
