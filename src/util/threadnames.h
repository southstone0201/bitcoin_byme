// Copyright (c) 2018-2019 The Namseokcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef NAMSEOKCOIN_UTIL_THREADNAMES_H
#define NAMSEOKCOIN_UTIL_THREADNAMES_H
...
#endif // NAMSEOKCOIN_UTIL_THREADNAMES_H
