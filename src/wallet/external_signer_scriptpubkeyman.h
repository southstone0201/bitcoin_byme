...
#ifndef NAMSEOKCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define NAMSEOKCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // NAMSEOKCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
