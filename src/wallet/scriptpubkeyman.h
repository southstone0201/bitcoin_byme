...
#ifndef NAMSEOKCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define NAMSEOKCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Namseokcoin Core wallet was originally a collection of unrelated private
...
#endif // NAMSEOKCOIN_WALLET_SCRIPTPUBKEYMAN_H
