...
#ifndef NAMSEOKCOIN_WALLET_TRANSACTION_H
#define NAMSEOKCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this namseokcoin node, and set to 0 for transactions that were created
...
#endif // NAMSEOKCOIN_WALLET_TRANSACTION_H
