...
#ifndef NAMSEOKCOIN_WALLET_WALLET_H
#define NAMSEOKCOIN_WALLET_WALLET_H
...
public:
     ...
     * namseokcoin-wallet tool code or by wallet migration code. If this is called
...
#endif // NAMSEOKCOIN_WALLET_WALLET_H
