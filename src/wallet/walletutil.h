...
#ifndef NAMSEOKCOIN_WALLET_WALLETUTIL_H
#define NAMSEOKCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! namseokcoin from opening the wallet, thinking it was newly created, and
...
#endif // NAMSEOKCOIN_WALLET_WALLETUTIL_H
