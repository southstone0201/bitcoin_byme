...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NamseokcoinTestFramework
    pass


class ExampleTest(NamseokcoinTestFramework):
    # Each functional test is a subclass of the NamseokcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        NamseokcoinTestFramework class so other tests can use it."""
