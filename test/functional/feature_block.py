...
class FullBlockTest(NamseokcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [[
            ...
            '-par=1', # Until https://github.com/namseokcoin/namseokcoin/issues/30960 is fixed
        ]]
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure namseokcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure namseokcoind isn't accepting b28
        ...
        # namseokcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the namseokcoin code has custom code which does so);
