...
# The block reward of coinbaseoutput.nValue (50) NSC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 NSC/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"namseokcoin-cli -h\" for help or \"namseokcoin-cli listwallets\" to see "
...
class TestNamseokcoinCli(NamseokcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `namseokcoin-cli getblockchaininfo`")
        ...
        # Prevent namseokcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and namseokcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and namseokcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (NSC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (NSC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 NSC) to the default wallet.
            ...
            # Test namseokcoin-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestNamseokcoinCli(__file__).main()
