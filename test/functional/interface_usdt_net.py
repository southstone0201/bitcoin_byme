...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/namseokcoin/namseokcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(NamseokcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our namseokcoind node")
