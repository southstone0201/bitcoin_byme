...
By default, namseokcoind will dump mempool on shutdown and
...
class MempoolPersistTest(NamseokcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent namseokcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
