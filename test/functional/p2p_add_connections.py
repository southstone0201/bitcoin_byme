#!/usr/bin/env python3
# Copyright (c) 2020-present The Namseokcoin Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The namseokcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(NamseokcoinTestFramework):
    ...
    def run_test(self):
        ...
        # namseokcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that namseokcoind sends its own version prior to processing
