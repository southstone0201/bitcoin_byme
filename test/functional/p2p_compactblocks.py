...
# TestP2PConn: A peer we use to send messages to namseokcoind, and store responses.
...
class CompactBlocksTest(NamseokcoinTestFramework):
    ...
    # This test actually causes namseokcoind to (reasonably!) disconnect us, so do this last.
    ...
    # namseokcoind's choice of nonce.
    ...
    # Test that namseokcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for namseokcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # namseokcoind will not send blocktxn responses for blocks whose height is
