...
Verify that a namseokcoind node can use an external signer command.
...
class RPCSignerTest(NamseokcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart namseokcoind with -signer=<cmd>',
