...
class TestShell:
    """Wrapper Class for NamseokcoinTestFramework.

    The TestShell class extends the NamseokcoinTestFramework
    ...
    class __TestShell(NamseokcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by NamseokcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # NamseokcoinTestFramework instances are supposed to be constructed with the path
