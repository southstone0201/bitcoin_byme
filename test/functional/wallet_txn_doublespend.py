...
class TxnMallTest(NamseokcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 NSC:
        ...
        # First: use raw transaction API to send 1240 NSC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 NSC coin each
        ...
        # Node0's balance should be starting balance, plus 50NSC for another
        ...
        # Node0's total balance should be starting balance, plus 100NSC for
