...
```sh
DOCKER_BUILDKIT=1 docker build -t namseokcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/namseokcoin -it namseokcoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/namseokcoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/namseokcoin-core/leveldb-subtree.git (branch namseokcoin-fork)
* for `src/crypto/ctaes`: https://github.com/namseokcoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/namseokcoin-core/crc32c-subtree.git (branch namseokcoin-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/namseokcoin-core/secp256k1.git
```
