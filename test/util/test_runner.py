...
# Copyright 2016-2017 The Namseokcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for namseokcoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "namseokcoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./namseokcoin-util":
        execprog = os.getenv("NAMSEOKCOINUTIL", default=execprog)
    elif testObj["exec"] == "./namseokcoin-tx":
        execprog = os.getenv("NAMSEOKCOINTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, namseokcoin-tx
